...
json_file = open(os.path.join(__location__, 'COVID-DATI/dati-json/dpc-covid19-ita-andamento-nazionale.json'))
...
_, media_nuovi_positivi = media_su_giorni(date, nuovi_positivi, giorni)
...
plt.xticks(np.arange(0, len(date), step=10))
plt.xlabel('Date')
